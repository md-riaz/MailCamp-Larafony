...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .error-details { background: #f7fafc; padding: 1rem; border-radius: 8px; margin-bottom: 2rem; font-family: 'Courier New', monospace; font-size: 0.9rem; color: #4a5568; word-break: break-all; }
...
<body>
    ...
    <div class="container">
        <div class="error-box" role="group" aria-labelledby="title">
            ...
            <h1 id="title" class="error-title">Page Not Found</h1>
