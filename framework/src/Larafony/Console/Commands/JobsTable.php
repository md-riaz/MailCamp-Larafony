...
#[AsCommand(name: 'table:jobs')]
class JobsTable extends MakeMigration
{
    public function __construct(OutputContract $output, protected ContainerContract $container)
    {
        ...
        $this->name = ClockFactory::now()->format('Y_m_d_His_') . 'create_jobs_table.php';
    }
    ...
    {
        $stubPath = dirname(__DIR__, 4) . '/stubs/jobs_migration.stub';
